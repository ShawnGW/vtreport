...
public class ExceLReportModel24 extends Report_Model {

	private static final File Model=new File("/Config/BID_P7516G.xlsx");
	private final Integer[] Bin_Array={1,700,701,702,300,310,311,320,330,340,400,410,430,440,450,500,501,510,520,610,611,612,613,615,616,800,802,803,900,901,903,907,908,909};
	public ExceLReportModel24() throws IOException {
		super(Model);
