...
public class ExceLReportModel19 extends Report_Model {

	private static final File Model=new File("/Config/AMC.xlsx");
	...
	public ExceLReportModel19() throws IOException {
		super(Model);
