...
public class TextReportModel40 extends FTPRealseModel implements Text_Report {
	...
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce, String FileName)
		...
		TextReportModel40 model15=new TextReportModel40();
		...
		for (int k = 0; k < Filelist.length; k++) {
			...
			out.print("\r\n");
			out.print("\r\n");
			out.print("A - Good  die(bin 1)    "+PassDie_R+"EA\r\n");
			out.print("X - Bad die\r\n");
			out.print("M - Eye shot boundry\r\n");
			out.flush();
			out.close();
