...
public class ExceLReportModel22 extends Report_Model{

	private static final File Model=new File("/Config/FJT.xlsx");
	...
	public ExceLReportModel22() throws IOException {
		super(Model);
