...
public class ExceLReportModel42 extends Report_Model {

	private static final File Model=new File("/Config/FQR.xlsx");
	public ExceLReportModel42() throws IOException {
		super(Model);
	...
	public void Write_Excel(String CustomerCode, String Device, String Lot, String CP, File file, File Result_Excel) {
		...
		try {			
			...
			sheet.getRow(3).getCell(1).setCellValue(file.listFiles().length+" pcs");
			...
			for (int i =0; i< Prober_Mappings.length; i++) {
				try {
					...
					Total_FailDie+=FailDie_R;
					Total_PassDie+=PassDie_R;
					Total_TotalDie+=GrossDie_R;
						...
						for (int k = 0; k < Col_R; k++) {						
							if (MapCell_R[j][k]!=null) {
								...
								if (MapCell_R[j][k].equals("M")) {
									...
									if (MapCell_R[j][k].equals("0")||MapCell_R[j][k].equals("1")||MapCell_R[j][k].equals("13")||MapCell_R[j][k].equals("12")||MapCell_R[j][k].equals("11")) {
...
//						}						
					...
					sheet.getRow(36).createCell(4).setCellValue(Double.valueOf(String.format("%4.2f", (double)Total_TotalDie/file.listFiles().length)));
					sheet.getRow(36).createCell(5).setCellValue(Double.valueOf(String.format("%4.2f", (double)Total_PassDie/file.listFiles().length)));
					sheet.getRow(36).createCell(6).setCellValue(Double.valueOf(String.format("%4.2f", (double)Total_FailDie/file.listFiles().length)));
					sheet.getRow(36).createCell(7).setCellValue(Float.valueOf(String.format("%4.2f", (double)Total_PassDie*100/Total_TotalDie))/100);
					...
					sheet.getRow(37).getCell(4).setCellStyle(Center_Style);
					sheet.getRow(37).getCell(5).setCellStyle(Center_Style);
					sheet.getRow(37).getCell(6).setCellStyle(Center_Style);
					sheet.getRow(37).createCell(7).setCellValue(Float.valueOf(String.format("%4.2f", (double)Total_PassDie*100/Total_TotalDie))/100);
					sheet.getRow(37).getCell(7).setCellStyle(Data_Style);
					
					sheet.getRow(5).createCell(1).setCellValue(Total_PassDie);
					sheet.getRow(6).createCell(1).setCellValue(Total_TotalDie);
					sheet.getRow(5).getCell(1).setCellStyle(Center_Style);
					sheet.getRow(6).getCell(1).setCellStyle(Center_Style);
					sheet.getRow(7).createCell(1).setCellValue(Double.valueOf(String.format("%4.2f", (double)Total_PassDie*100/Total_TotalDie))/100);
