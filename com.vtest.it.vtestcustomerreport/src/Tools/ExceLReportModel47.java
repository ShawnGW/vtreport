...
public class ExceLReportModel47 extends Report_Model {

	private static final File Model=new File("/Config/A113_Format.xlsx");
	private final Integer[] Bin_Array={1,201,202,203,204,205,206,207,208,209,210,211,212,213,214,301,302,303,304,305,306,307,308,309,310,311,312,316,317,322,402,403,404,405,318,319,320,321,408,409,410,411,412,413,414,415,416,417,418,419,420,421,422,501,502,503,504,505,506,507,508,509,510,511,512,513,514,515,516,517,601,602,603,604,605,606,607,608,609,610,611,702,703,612,518,519,520,521,801,802,1201,1202,1203,1204,1205,1206,1207,1208
};
	public ExceLReportModel47() throws IOException {
		super(Model);
