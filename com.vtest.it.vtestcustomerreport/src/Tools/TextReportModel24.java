...
public class TextReportModel24 extends FTPRealseModel implements Text_Report {
	@Override
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce, String FileName)
			throws IOException {
		// TODO Auto-generated method stub
		TextReportModel24 model15=new TextReportModel24();
...
//				File Result_Text=new File("/TestReport/CustReport/"+CustomerCode+"/"+Device+"/"+Lot+"/"+CP+"/"+FinalName);
				...
				for (int i = 0; i < Row_R; i++) {
					for (int j =0; j < Col_R; j++) {
							out.print(MapCell_Modify4.Modify2(MapCell_R[i][j]));		
					}
					out.print("\r\n");
				}
				out.flush();
