...
public class TextReportModel2 extends FTPRealseModel  implements Text_Report {

	@Override
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce,String FileName)
			throws IOException {
		TextReportModel2 model2=new TextReportModel2();
		...
		for (int k = 0; k < Filelist.length; k++) {		
			...
			out.print("ALIGN MARK="+properties.get("")+"\r\n");
