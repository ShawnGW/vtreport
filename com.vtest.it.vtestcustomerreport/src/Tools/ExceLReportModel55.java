...
public class ExceLReportModel55 extends Report_Model {

	private static final File Model=new File("/Config/GXLX2.xlsx");
	private final Integer[] Bin_Array={1,201,202,203,204,205,206,207,301,308,309,302,303,304,305,306,307,502,503,506,501,505,504,700,701,702,703,704,705,706,707,601,602,603,604,605,606,607,608,609,610,611,615,616,617,618,612,614,622,619,625,621,620,800,801,802,803,804,805,420,421,422,423,424,425,426,400,901
};
	public ExceLReportModel55() throws IOException {
		super(Model);
