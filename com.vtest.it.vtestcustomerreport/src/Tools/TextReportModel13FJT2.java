...
public class TextReportModel13FJT2 extends FTPRealseModel implements Text_Report {
	@Override
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce, String FileName)
			throws IOException {
		// TODO Auto-generated method stub
		TextReportModel13FJT2 model13=new TextReportModel13FJT2();
			...
			for (int i = 0; i < Row_R; i++) {
				for (int j = 0; j < Col_R; j++) {
					if (MapCell_R[i][j]==null) {
						...
						if (passList.contains(MapCell_R[i][j]))
							out.print("1");
						else 
							out.print("X");
					}
