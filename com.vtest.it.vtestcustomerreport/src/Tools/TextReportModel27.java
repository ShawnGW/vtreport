...
public class TextReportModel27 extends FTPRealseModel implements Text_Report {
	...
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce, String FileName)
		...
		TextReportModel27 model15=new TextReportModel27();
		...
		for (int k = 0; k < Filelist.length; k++) {
			...
			out.print("Notch side:"+Flat_R.substring(0, 1).toUpperCase()+Flat_R.substring(1).toLowerCase()+"\r\n");
			out.print("\r\n");
			out.print("\r\n");
			...
			out.print("\r\n");
			for (int i = TestDie_MinX_R; i < Row_R+3; i++) {
				for (int j = 0; j < Col_R; j++) {
					try {
