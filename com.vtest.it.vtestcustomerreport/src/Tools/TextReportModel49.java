...
public class TextReportModel49 extends FTPRealseModel implements Text_Report {
	...
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce, String FileName)
		...
		TextReportModel49 model15=new TextReportModel49();
		...
		for (int k = 0; k < Filelist.length; k++) {
			...
			out.print(Wafer_ID_R+".MAP\r\n");
			out.print("Customer Device ID:"+Device+"\r\n");
			out.print("Customer Code:"+"\r\n");
			out.print("Mapping file:"+Wafer_ID_R+".MAP\r\n");
			out.print("Notch side:"+Flat_R.toUpperCase()+"\r\n");
			out.print("\r\n");
