...
public class ExceLReportModel32 extends Report_Model {

	private static final File Model=new File("/Config/GXBB_Format.xlsx");
	...
	public ExceLReportModel32() throws IOException {
		super(Model);
		...
		try {			
			...
			for (int i =0; i< Prober_Mappings.length; i++) {
				try {
					...
					System.out.println(GrossDie_R+":"+MES_GrossDie);
