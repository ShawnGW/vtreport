...
public class ExceLReportModel23 extends Report_Model{


	private static final File Model=new File("/Config/BID_P7516F.xlsx");
	private final Integer[] Bin_Array={1,200,201,202,300,310,311,320,330,340,400,410,430,440,450,500,501,510,520,610,611,612,613,615,616,800,802,803,900,901,903,907,908,909
};
	public ExceLReportModel23() throws IOException {
		super(Model);
				...
				try {
					...
					for (int j = 0; j < MapRows+1; j++) {
						...
						if (j>2&&j<Bin_Array.length+3) {
							...
							XSSFCell empty_cell=Map_Row.createCell(Col_R+3);
							//Integer color=(Integer.valueOf(Integer.toString((Bin_Array[j-3]-1)).substring(0, 1)));
							if (Bin_Array[j-3]<33)								
