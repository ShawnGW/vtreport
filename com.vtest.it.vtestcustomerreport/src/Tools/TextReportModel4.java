...
public class TextReportModel4 extends FTPRealseModel implements Text_Report{
...
//		}
//		File[] filelist=new File(("/home/UploadReport/TestReportRelease/"+CustomerCode+"/"+Device+"/"+Lot+"/"+CP+"/Fab_Mapping/")).listFiles();
//		for (int i = 0; i < filelist.length; i++) {
