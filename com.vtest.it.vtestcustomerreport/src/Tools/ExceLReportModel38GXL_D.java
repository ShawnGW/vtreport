...
public class ExceLReportModel38GXL_D extends Report_Model {

	private static final File Model=new File("/Config/GXL_B_Format_Update.xlsx");
	...
	public ExceLReportModel38GXL_D() throws IOException {
		super(Model);
