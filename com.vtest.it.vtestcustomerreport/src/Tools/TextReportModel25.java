...
public class TextReportModel25 extends FTPRealseModel implements Text_Report {
	...
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce,String FileName)
		...
		for (int k = 0; k < Filelist.length; k++) {
			...
			out.print("\r\n");
			out.print("\r\n");
			out.print("============ Wafer Information (GC) ==========="+"\r\n");
			out.print("  Fab: VTEST\r\n");
			out.print("  Device: "+Device+"\r\n");
			out.print("  Lot NO: "+Lot+"\r\n");
			out.print("  Slot No: "+"\r\n");
			out.print("  Wafer ID: "+waferid+"\r\n");
			out.print("  Test programme: "+Program_R+"\r\n");
			out.print("  Tester No: "+Tester_R+"\r\n");
			out.print("  ProberCard ID: "+ProberCard_R+"\r\n");
			...
			out.print("\r\n");
			out.print("\r\n");
			out.print("             Bin Data Deatil Summary"+"\r\n");
			out.print("======================================================================="+"\r\n");
			...
			Integer Bin64=0;
			if (Bin_Summary_R.containsKey(64)) {				
				Bin64=Bin_Summary_R.get(64);
			}
			for (int j = 0; j < 5-Bin64.toString().length(); j++) {
				sb.append("0");
			}
			out.print(sb.toString()+Bin64+"  |\r\n");
			String percent=String.format("%.2f", ((double)Bin64*100/gross_die));
			if (percent.length()!=5) {		
				percent="0"+percent;
			}
			out.print(percent+"% |\r\n");			
