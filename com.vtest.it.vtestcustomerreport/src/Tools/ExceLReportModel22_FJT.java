...
public class ExceLReportModel22_FJT extends Report_Model{

	private static final File Model=new File("/Config/FJT_FJT.xlsx");
	private final Integer[] Bin_Array={1,21,22,23,24,25,26,27,31,32,33,34,35,36,37,38,39,41,42,43,44,45,71,72,73,74,75,76,77,78,81,82,83,84,85,86,87,88,89,91,92,93,94,95,96,97,601,602,603,604,605,606,607,608,609,610,611,612,613,614,615,616,617,618,619,620,621,622,623,624
};
	public ExceLReportModel22_FJT() throws IOException {
		super(Model);
	...
	public void Write_Excel(String CustomerCode, String Device, String Lot, String CP, File file, File Result_Excel) {
		...
		try {			
			...
			Row_Summary.getCell(23).setCellValue(Integer.valueOf(propertiesFirst.get("MES Test Gross Die")));
			...
			for (int i =0; i< Prober_Mappings.length; i++) {
				try {
					...
					Rows.getCell(73).setCellFormula("SUM(E"+(7+RightID_R)+":BU"+(7+RightID_R)+")");
					Rows.getCell(74).setCellValue(properties.get("PO Number"));
