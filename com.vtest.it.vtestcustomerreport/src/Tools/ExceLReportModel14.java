...
public class ExceLReportModel14 extends Report_Model {

	private static final File Model=new File("/Config/AK1606E.xlsx");
	public ExceLReportModel14() throws IOException {
		super(Model);
