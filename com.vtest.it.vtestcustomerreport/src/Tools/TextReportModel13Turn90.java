...
public class TextReportModel13Turn90 extends FTPRealseModel implements Text_Report {
	@Override
	public void Write_text(String CustomerCode, String Device, String Lot, String CP, File DataSorce, String FileName)
			throws IOException {
		// TODO Auto-generated method stub
		TextReportModel13Turn90 model13=new TextReportModel13Turn90();
				...
				for (int j = 0; j < Col_R; j++) {
					if (MapCell_R[i][j]==null) {
						...
						if (MapCell_R[i][j].equals("1"))
							out.print("1");
						else if (MapCell_R[i][j].equals("10"))
							out.print("2");
						else 
							out.print("X");
					}
