...
public class ExceLReportModel15 extends Report_Model {

	private static final File Model=new File("/Config/AK1506G.xlsx");
	public ExceLReportModel15() throws IOException {
		super(Model);
