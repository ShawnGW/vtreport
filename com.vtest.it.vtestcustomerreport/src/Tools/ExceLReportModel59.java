...
public class ExceLReportModel59 extends Report_Model {

	private static final File Model=new File("/Config/ZYV.xlsx");
	private final Integer[] Bin_Array={1,5,6,14,16,21,22,23,24,25,31,32,33,34,38};
	public ExceLReportModel59() throws IOException {
		super(Model);
	...
	public void Write_Excel(String CustomerCode, String Device, String Lot, String CP, File file, File Result_Excel) {
		...
		try {			
			...
			Row_Summary.getCell(11).setCellValue(MES_GrossDie);
			Row_Summary.getCell(9).setCellValue(file.listFiles().length);
			Row_Summary.getCell(30).setCellValue(propertiesFirst.get("Tester Program"));
