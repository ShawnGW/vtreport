...
public class ExceLReportModel25 extends Report_Model {

	private static final File Model=new File("/Config/FUA_LINBAO.xlsx");
	private final Integer[] Bin_Array={1,5,6,7,12,13,14,21,22,23,24,25,31,32,33,34,38};
	public ExceLReportModel25() throws IOException {
		super(Model);
