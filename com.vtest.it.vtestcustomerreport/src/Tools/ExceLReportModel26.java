...
public class ExceLReportModel26 extends Report_Model {

	private static final File Model=new File("/Config/FUA_PX3.xlsx");
	private final Integer[] Bin_Array={1,5,6,7,12,13,14,15,21,22,23,24,25,31,32,33,34,38,99};

	public ExceLReportModel26() throws IOException {
		super(Model);
